        ...
        <div className="grid grid-cols-1 lg:grid-cols-[18rem_1fr] gap-4 h-full">
          ...
          <aside className="h-full rounded-2xl border border-neutral-800 bg-neutral-950/70 p-3 overflow-hidden flex flex-col">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-sm text-neutral-300 font-medium">
                Chat Sessions
              </h2>
              <button
                type="button"
            ...
            <div className="space-y-1 flex-1 overflow-y-auto pr-1">
              ...
              {sessions.map((s) => (
                <button
                  ...
                  className={`w-full text-left rounded-lg px-2 py-2 text-sm border transition ${
                    s.id === sessionId
            ...
            <div className="h-full max-w-3xl mx-auto flex flex-col min-h-0">
                  ...
                  >
                    {selectedProjectId ? (
                      <>
                        ...
                        <span
                          className={`shrink-0 px-1.5 py-0.5 rounded-full text-[10px] border leading-none ${
                            projects.find(
                              (p) => p.projectId === selectedProjectId,
                            )?.status === "OPEN"
                    ...
                    <ChevronDown
                      size={12}
                      className={`ml-auto shrink-0 text-neutral-500 duration-150 ${projectDropdownOpen ? "rotate-180" : ""}`}
                    />
                  </button>
                    ...
                    <div className="absolute right-0 top-full mt-1.5 w-64 bg-neutral-900 border border-neutral-700 rounded-xl shadow-2xl shadow-black/40 z-50 overflow-hidden">
                      <div className="p-1.5 max-h-72 overflow-y-auto">
                        ...
                        <button
                          ...
                          className={`w-full flex items-center gap-2 px-3 py-2 rounded-lg text-xs duration-100 ${
                            !selectedProjectId
                        ...
                        {projects.map((p) => {
                          ...
                          return (
                            <button
                              ...
                              className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs duration-100 ${
                                isSelected
                                  ? "bg-emerald-950/40 text-emerald-300"
              ...
              {emptyState ? (
                  ...
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-neutral-400 text-sm max-w-md mx-auto">
                        Spina is your Spinach assistant: short, clear answers
                        grounded in your workspace context, friendly for quick
                        questions, and tuned for simple explanations.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex-1 overflow-y-auto px-1 py-4 space-y-6 min-h-0">
                  {messages
                    .filter(
                      (msg) => !(msg.role === "AI" && !msg.content && loading),
                    )
                    .map((msg) => (
                      <div
                        key={msg.id}
